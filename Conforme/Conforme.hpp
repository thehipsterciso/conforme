...
throw CConformeException(CConformeException::eError1, _T("Format error"));
...
throw CConformeException(CConformeException::eError1, _T("Types incompatible!"));
    
#define ThrowValuesNotConvertableError() \
throw CConformeException(CConformeException::eError1, _T("Values are not convertable"));
    
#if defined( __GNUC__ )
#define __int64 long long
#define CONFORME_INT64 long long
...
#define XC2TS(x) StrX(x).localForm()
    ...
    class CONFORME_DECLSPECIFIER CBaseObject
    {
    public:
        virtual ~CBaseObject() {}
    };
