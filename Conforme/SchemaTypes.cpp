...
template < typename T>
static tstring conformeitoa( T value, int base)
{
    tstring buf;
...
namespace conforme
{
    ...
    int CoreTypes::CastToInt(unsigned int i)
    {
        if (i > (unsigned) std::numeric_limits<int>::max())
            throw conforme::OutOfRangeException(_T("unsignedInt"), _T("int"), CastToString(i));
        return (int)i;
    }
    ...
    int CoreTypes::CastToInt(double d)
    {
        if (d < std::numeric_limits<int>::min() || d > std::numeric_limits<int>::max())
            throw conforme::OutOfRangeException(_T("double"), _T("int"), CastToString(d));
        return (int)d;
    }
    ...
    int CoreTypes::CastToInt(const string_type& s)
    {
        string_type str = TrimWhitespace(s);
        if (str == _T("NaN") || str == _T("INF") || str == _T("-INF"))
            throw conforme::OutOfRangeException(_T("string"), _T("int"), s);
        ...
        switch (PrepareNumber(buffer, str.c_str()))
        {
            ...
            default:
                throw conforme::StringParseException(_T("int"), s);
        }
    }
    ...
    int CoreTypes::CastToInt(__int64 i)
    {
        if (i < std::numeric_limits<int>::min() || i > std::numeric_limits<int>::max())
            throw conforme::OutOfRangeException(_T("long"), _T("int"), CastToString(i));
        return (int)i;
    }
    ...
    int CoreTypes::CastToInt(unsigned __int64 i)
    {
        if (i > std::numeric_limits<int>::max())
            throw conforme::OutOfRangeException(_T("unsignedLong"), _T("int"), CastToString(i));
        return (int)i;
    }
    ...
    {
        if (i < 0)
            throw conforme::OutOfRangeException(_T("int"), _T("unsignedInt"), CastToString(i));
        return (unsigned)i;
    }
    ...
    unsigned CoreTypes::CastToUInt(double d)
    {
        if (d < 0 || d > std::numeric_limits<unsigned>::max())
            throw conforme::OutOfRangeException(_T("double"), _T("unsignedInt"), CastToString(d));
        return (unsigned)d;
    }
    ...
    unsigned CoreTypes::CastToUInt(const string_type& s)
    {
        string_type str = TrimWhitespace(s);
        if (str == _T("NaN") || str == _T("INF") || str == _T("-INF"))
            throw conforme::OutOfRangeException(_T("string"), _T("unsignedInt"), s);
        ...
        switch (PrepareNumber(buffer, str.c_str()))
        {
            ...
            default:
                throw conforme::StringParseException(_T("unsignedInt"), s);
        }
    }
    ...
    unsigned CoreTypes::CastToUInt(__int64 i)
    {
        if (i < 0 || i > std::numeric_limits<unsigned>::max())
            throw conforme::OutOfRangeException(_T("long"), _T("unsignedInt"), CastToString(i));
        return (unsigned)i;
    }
    ...
    unsigned CoreTypes::CastToUInt(unsigned __int64 i)
    {
        if (i > std::numeric_limits<unsigned>::max())
            throw conforme::OutOfRangeException(_T("unsignedLong"), _T("unsignedInt"), CastToString(i));
        return (unsigned)i;
    }
    ...
    __int64 CoreTypes::CastToInt64(double d)
    {
        if (d < std::numeric_limits<__int64>::min() || d > std::numeric_limits<__int64>::max())
            throw conforme::OutOfRangeException(_T("double"), _T("long"), CastToString(d));
    ...
    __int64 CoreTypes::CastToInt64(const string_type& s)
    {
        string_type str = TrimWhitespace(s);
        if (str == _T("NaN") || str == _T("INF") || str == _T("-INF"))
            throw conforme::OutOfRangeException(_T("string"), _T("long"), s);
    ...
    __int64 CoreTypes::CastToInt64(unsigned __int64 i)
    {
        if (i > (unsigned __int64) std::numeric_limits<__int64>::max())
            throw conforme::OutOfRangeException(_T("unsignedLong"), _T("long"), CastToString(i));
        return (__int64)i;
    }
    ...
    unsigned __int64 CoreTypes::CastToUInt64(double d)
    {
        if (d < 0 || d > CastToDouble(std::numeric_limits<unsigned __int64>::max()))
            throw conforme::OutOfRangeException(_T("double"), _T("unsignedLong"), CastToString(d));
    ...
    unsigned __int64 CoreTypes::CastToUInt64(const string_type& s)
    {
        string_type str = TrimWhitespace(s);
        if (str == _T("NaN") || str == _T("INF") || str == _T("-INF"))
            throw conforme::OutOfRangeException(_T("string"), _T("unsignedLong"), s);
    ...
    {
        if (i < 0)
            throw conforme::OutOfRangeException(_T("long"), _T("unsignedLong"), CastToString(i));
        return (unsigned __int64)i;
    }
    ...
    string_type CoreTypes::CastToString(const conforme::QName& qn)
    {
        return qn.ToString();
    }
    
    conforme::QName CoreTypes::CastToQName(const string_type& s)
    {
        return conforme::QName(s);
    }
    
    
    
    conforme::QName CoreTypes::CastToQName(const conforme::QName& qn)
    {
        return qn;
    }
    ...
    string_type CoreTypes::CastToString(int i) { return conformeitoa( i, 10);  }
    string_type CoreTypes::CastToString(unsigned int i) { return conformeitoa( i, 10); }
    string_type CoreTypes::CastToString(__int64 i) { return conformeitoa( i, 10); }
    string_type CoreTypes::CastToString(unsigned __int64 i) { return conformeitoa( i, 10); }
    ...
    bool CoreTypes::CastToBool(const string_type& v)
    {
        ...
        if (s == _T("false") || s == _T("0"))
            return false;
        throw conforme::StringParseException(_T("bool"), v);
    }
    ...
    string_type CoreTypes::CastToString(const conforme::DateTime& dt, DateTimeFormat format)
    {
        string_type result;
        ...
        __int64 intraday = value % (86400 * conforme::TicksPerSecond);
        if (intraday < 0) intraday += (86400 * conforme::TicksPerSecond);
        unsigned fraction = (unsigned)(intraday % conforme::TicksPerSecond);
        intraday /= conforme::TicksPerSecond;
        ...
        switch (format)
        {
            ...
            case DateTimeFormat_S_Seconds:
                ...
                FormatNumber(result, unsigned(value / conforme::TicksPerSecond), 1);
                FormatFraction(result, unsigned(value % conforme::TicksPerSecond), 7);
                break;
            ...
            case DateTimeFormat_S_Days:
                ...
                FormatNumber(result, unsigned(value / (86400 * conforme::TicksPerSecond)), 1);
                FormatFraction(result, unsigned(value % (86400 * conforme::TicksPerSecond) / 86400), 7);
                break;
        }
    ...
    string_type CoreTypes::CastToString(conforme::DateTime dt)
    {
        return CastToString(dt, DateTimeFormat_W3_dateTime);
    }
    
    
    string_type CoreTypes::CastToString(conforme::Duration dur)
    {
        string_type result;
        if (dur.IsNegative() && dur.IsPositive())
            throw conforme::ValueNotRepresentableException(_T("duration"),
    ...
    string_type CoreTypes::CastToString(conforme::DayTimeDuration dur)
    {
        string_type result;
        if (dur.IsNegative())
        {
    ...
    string_type CoreTypes::CastToString(conforme::YearMonthDuration dur)
    {
        string_type result;
    ...
    bool TryParseDateTime(const string_type& input, unsigned formatFlags, conforme::DateTime& value)
    {
        ...
        state.timezone = conforme::DateTime::NO_TIMEZONE;
        ...
        value = conforme::DateTime(
                                 state.year, state.month, state.day, state.hour, state.minute,
                                 state.second + (double)state.fraction / conforme::TicksPerSecond, state.timezone);
        return true;
    }
    
    
    conforme::DateTime CoreTypes::ParseTime(const string_type& s, unsigned addendumFlags )
    {
        conforme::DateTime dt;
        if (!TryParseDateTime(s, CoreTypes::ParseDateTimeFlag_AllowTime | addendumFlags, dt))
            throw conforme::StringParseException(_T("time"), s);
        
        return dt;
    }
    
    
    conforme::DateTime CoreTypes::CastToDateTime(const string_type& s)
    {
        conforme::DateTime dt;
        if (!TryParseDateTime(s, CoreTypes::ParseDateTimeFlag_AllowTime|CoreTypes::ParseDateTimeFlag_AllowDate, dt))
            throw conforme::StringParseException(_T("dateTime"), s);
        
        return dt;
    }
    
    conforme::DateTime CoreTypes::CastToDateTime(const conforme::DateTime& s, DateTimeFormat format)
    {
        return CastToDateTime(s);
    }
    
    
    conforme::Duration CoreTypes::CastToDuration(const string_type& s, const conforme::Duration::ParseType pt)
    {
        bool positive = true;
        DateTimeParseState state;
        state.pos = 0;
        ...
        if (state.pos == s.size())
            throw conforme::StringParseException(_T("duration"), s);
        ...
        if (number)    // try 'Y'
        {
            ...
            if (s.at(state.pos) == 'Y')
            {
                if (pt == Duration::DAYTIME)
                    throw conforme::StringParseException(_T("daytimeduration"), s);
                anyFound = true;
        ...
        if (number) // try 'D'
        {
            ...
            if (s.at(state.pos) == 'D')
            {
                if (pt == Duration::YEARMONTH)
                    throw conforme::StringParseException(_T("yearmonthduration"), s);
                anyFound = true;
        ...
        return conforme::Duration(conforme::YearMonthDuration(positive ? ymvalue : -ymvalue), conforme::DayTimeDuration(positive ? dtvalue : -dtvalue));
    }
    ...
    conforme::YearMonthDuration CoreTypes::CastToYearMonthDuration(const string_type& s)
    {
        int yearMonthValue;
        __int64 dayTimeValue;
        conforme::ParseDateTime( s, yearMonthValue, dayTimeValue);
        return conforme::YearMonthDuration(yearMonthValue);
    }
    
    conforme::DayTimeDuration CoreTypes::CastToDayTimeDuration(const string_type& s)
    {
        int yearMonthValue;
        __int64 dayTimeValue;
        conforme::ParseDateTime( s, yearMonthValue, dayTimeValue);
        return conforme::DayTimeDuration(dayTimeValue);
    }
    
    conforme::DateTime CoreTypes::CastToDateTime(const conforme::DateTime& s) { return s; }
    conforme::Duration CoreTypes::CastToDuration(const conforme::Duration& s) { return s; }
    conforme::YearMonthDuration CoreTypes::CastToYearMonthDuration(const conforme::YearMonthDuration& s) { return s; }
    conforme::DayTimeDuration CoreTypes::CastToDayTimeDuration(const conforme::DayTimeDuration& s) { return s; }
    ...
    {
        if (v == 0)
            throw conforme::Error(_T("Trying to read NULL value."));
        return *v;
    }
    ...
    conforme::DateTime CoreTypes::CastToDateTime(const conforme::DateTime* v)
    {
        if (v == 0)
            throw conforme::Error(_T("Trying to read NULL value."));
        return *v;
    ...
    conforme::Duration CoreTypes::CastToDuration(const conforme::Duration* v)
    {
        if (v == 0)
            throw conforme::Error(_T("Trying to read NULL value."));
        return *v;
    ...
    conforme::DateTime* CoreTypes::Box(const conforme::DateTime& dt)
    {
        return new conforme::DateTime(dt);
    }
    
    conforme::Duration* CoreTypes::Box(const conforme::Duration& d)
    {
        return new conforme::Duration(d);
    }
    ...
    conforme::DateTime* CoreTypes::Box(conforme::DateTime* p)
    {
        if (p == 0) return 0;
        return new conforme::DateTime(*p);
    }
    
    conforme::Duration* CoreTypes::Box(conforme::Duration* p)
    {
        if (p == 0) return 0;
        return new conforme::Duration(*p);
    }
    ...
    conforme::DateTime CoreTypes::Unbox(conforme::DateTime* v)
    {
        if (v == 0)
            throw conforme::Error(_T("Trying to read NULL value."));
        return *v;
    ...
    conforme::Duration CoreTypes::Unbox(conforme::Duration* v)
    {
        if (v == 0)
            throw conforme::Error(_T("Trying to read NULL value."));
        return *v;
