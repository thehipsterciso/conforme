...
#pragma once
#ifndef XSDATATYPES_HPP
#define XSDATATYPES_HPP
...
namespace conforme
{
    ...
    {
    public:
        virtual string_type Format(const conforme::DateTime& v);
        virtual string_type Format(const conforme::Duration& v);
    ...
    CONFORME_DECLSPECIFIER extern ValueFormatter* Exported_TimeFormatter;
    CONFORME_DECLSPECIFIER extern ValueFormatter* Exported_DateFormatter;
    CONFORME_DECLSPECIFIER extern ValueFormatter* Exported_DateTimeFormatter;
    CONFORME_DECLSPECIFIER extern ValueFormatter* Exported_GYearFormatter;
    CONFORME_DECLSPECIFIER extern ValueFormatter* Exported_GMonthFormatter;
    CONFORME_DECLSPECIFIER extern ValueFormatter* Exported_GDayFormatter;
    CONFORME_DECLSPECIFIER extern ValueFormatter* Exported_GYearMonthFormatter;
    CONFORME_DECLSPECIFIER extern ValueFormatter* Exported_GMonthDayFormatter;
    CONFORME_DECLSPECIFIER extern ValueFormatter* Exported_IntegerFormatter;
    CONFORME_DECLSPECIFIER extern ValueFormatter* Exported_DecimalFormatter;
    CONFORME_DECLSPECIFIER extern ValueFormatter* Exported_AnySimpleTypeFormatter;
    CONFORME_DECLSPECIFIER extern ValueFormatter* Exported_DurationFormatter;
    CONFORME_DECLSPECIFIER extern ValueFormatter* Exported_DoubleFormatter;
    CONFORME_DECLSPECIFIER extern ValueFormatter* Exported_Base64BinaryFormatter;
    CONFORME_DECLSPECIFIER extern ValueFormatter* Exported_HexBinaryFormatter;
