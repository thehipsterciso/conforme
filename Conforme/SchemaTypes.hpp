...
/*    namespace mapforce
    ...
    class CONFORME_DECLSPECIFIER QName
    {
    public:
        string_type Uri;
        string_type Prefix;
    ...
    class CONFORME_DECLSPECIFIER CoreTypes
    {
    public:
        ...
        static string_type CastToString(conforme::DateTime dt);
        static string_type CastToString(conforme::Duration dur);
        static string_type CastToString(conforme::DayTimeDuration dt);
        static string_type CastToString(conforme::YearMonthDuration dur);
        static string_type CastToString(const std::vector<unsigned char>& v);
        static string_type CastToString(const conforme::QName& qn);
        static conforme::QName CastToQName(const string_type& s);
        static conforme::QName CastToQName(const conforme::QName& qn);
        ...
        static string_type CastToString(const conforme::DateTime& dt, DateTimeFormat format);
        static conforme::DateTime CastToDateTime(const conforme::DateTime& dt, DateTimeFormat format);
        
        static conforme::DateTime CastToDateTime(const string_type& s);
        static conforme::Duration CastToDuration(const string_type& s, const conforme::Duration::ParseType pt = conforme::Duration::DURATION);
        static conforme::YearMonthDuration CastToYearMonthDuration(const string_type& s);
        static conforme::DayTimeDuration CastToDayTimeDuration(const string_type& s);
        
        static conforme::DateTime CastToDateTime(const conforme::DateTime& s);
        static conforme::Duration CastToDuration(const conforme::Duration& s);
        static conforme::YearMonthDuration CastToYearMonthDuration(const conforme::YearMonthDuration& s);
        static conforme::DayTimeDuration CastToDayTimeDuration(const conforme::DayTimeDuration& s);
        ...
        static conforme::DateTime CastToDateTime(const conforme::DateTime* v);
        static conforme::Duration CastToDuration(const conforme::Duration* v);
        ...
        static conforme::DateTime ParseDateTime(const string_type& v) { return CastToDateTime(v); }
        static conforme::DateTime ParseDate(const string_type& v) { return CastToDateTime(v); }
        static conforme::DateTime ParseTime(const string_type& v) { return CastToDateTime(v); }
        static conforme::DateTime ParseTime(const string_type& v, unsigned addendumFlags );
        static conforme::DateTime ParseGYear(const string_type& v) { return CastToDateTime(v); }
        static conforme::DateTime ParseGYearMonth(const string_type& v) { return CastToDateTime(v); }
        static conforme::DateTime ParseGMonth(const string_type& v) { return CastToDateTime(v); }
        static conforme::DateTime ParseGMonthDay(const string_type& v) { return CastToDateTime(v); }
        static conforme::DateTime ParseGDay(const string_type& v) { return CastToDateTime(v); }
        static conforme::Duration ParseDuration(const string_type& v) { return CastToDuration(v); }
        ...
        static string_type DateTimeToString(const conforme::DateTime& v) { return CastToString(v, DateTimeFormat_W3_dateTime);}
        static string_type DateToString(const conforme::DateTime& v) { return CastToString(v, DateTimeFormat_W3_date); }
        static string_type TimeToString(const conforme::DateTime& v) { return CastToString(v, DateTimeFormat_W3_time); }
        static string_type GYearToString(const conforme::DateTime& v) { return CastToString(v, DateTimeFormat_W3_gYear);}
        static string_type GMonthToString(const conforme::DateTime& v) { return CastToString(v, DateTimeFormat_W3_gMonth); }
        static string_type GDayToString(const conforme::DateTime& v) { return CastToString(v, DateTimeFormat_W3_gDay); }
        static string_type GYearMonthToString(const conforme::DateTime& v) { return CastToString(v, DateTimeFormat_W3_gYearMonth); }
        static string_type GMonthDayToString(const conforme::DateTime& v) { return CastToString(v, DateTimeFormat_W3_gMonthDay); }
        static string_type DurationToString(const conforme::Duration& v) { return CastToString(v); }
        static conforme::DateTime DateTimeToDateTimeStamp(const conforme::DateTime& dt)
        {
            conforme::DateTime dtnew(dt);
        ...
        static conforme::DateTime ParseDateTimeStamp(const string_type& s)
        {
            conforme::DateTime dt = CastToDateTime(s);
            
            if( !dt.HasTimezone() )
                throw conforme::StringParseException(_T("DateTimeStamp"), s);
            return dt;
        }
        
        static string_type YearMonthDurationToString(const conforme::Duration& d)
        {
            return CastToString(DurationToYearMonthDuration(d).YearMonth());
        }
        
        static conforme::Duration DurationToYearMonthDuration(const conforme::Duration& d)
        {
            conforme::YearMonthDuration ymd(d.YearMonth());
            return conforme::Duration(ymd);
        }
        
        static conforme::Duration DurationToDayTimeDuration(const conforme::Duration& d)
        {
            conforme::DayTimeDuration dtd(d.DayTime());
            return conforme::Duration(dtd);
        }
        
        static conforme::Duration ParseYearMonthDuration(const string_type& s)
        {
            return CastToDuration(s, conforme::Duration::YEARMONTH);
        }
        
        static conforme::Duration ParseDayTimeDuration(const string_type& s)
        {
            return CastToDuration(s, conforme::Duration::DAYTIME);
        }
        ...
        static string_type QNameToString(const conforme::QName& v) { return CastToString(v); }
        static conforme::QName StringToQName(const string_type& s) { return CastToQName(s); }
        ...
        static long GYearToLong(const conforme::DateTime& v) { return v.Year(); }
        ...
        static conforme::DateTime* Box(const conforme::DateTime&);
        static conforme::Duration* Box(const conforme::Duration&);
        ...
        static conforme::DateTime* Box(conforme::DateTime*);
        static conforme::Duration* Box(conforme::Duration*);
        static double* Box(double*);
        ...
        static conforme::DateTime Unbox(conforme::DateTime*);
        static conforme::Duration Unbox(conforme::Duration*);
