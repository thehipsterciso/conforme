...
FILE* conformewfopen( const std::wstring& filename, const std::wstring& modes)
{
...
bool XercesTreeOperations::IsMember( xercesc::DOMNode* pNode, const conforme::MemberInfo* pMember )
{
...
XercesTreeOperations::MemberIterator XercesTreeOperations::GetElements(xercesc::DOMNode* pNode, const conforme::MemberInfo* pMemberInfo)
{
...
void XercesTreeOperations::SetValue(xercesc::DOMNode* pNode, const conforme::MemberInfo* pMemberInfo, const XMLCh* bValue)
{
...
void XercesTreeOperations::SetValue(xercesc::DOMNode* pNode, const conforme::MemberInfo* pMemberInfo, const string_type& sValue)
{
    SetValue(pNode, pMemberInfo, XercesStringTemp(sValue));
}

void XercesTreeOperations::SetValue(xercesc::DOMNode* pNode, const conforme::MemberInfo* pMemberInfo, const conforme::QName& qname)
{
    if (qname.Uri.empty())
    {
...
inline conforme::XmlFormatter* GetFormatter(const conforme::MemberInfo* pMember)
{
    if (((pMember->Binder->Types + pMember->DataType)->Formatter))
        return static_cast<conforme::XmlFormatter*>(*((pMember->Binder->Types + pMember->DataType)->Formatter));
    else
        return static_cast<conforme::XmlFormatter*>(conforme::AnySimpleTypeFormatter);
}


void XercesTreeOperations::SetValue(xercesc::DOMNode* pNode, const conforme::MemberInfo* pMemberInfo, bool b)
{
    SetValue(pNode, pMemberInfo, GetFormatter(pMemberInfo)->Format(b));
}

void XercesTreeOperations::SetValue(xercesc::DOMNode* pNode, const conforme::MemberInfo* pMemberInfo, int b)
{
    SetValue(pNode, pMemberInfo, GetFormatter(pMemberInfo)->Format((__int64)b));
}

void XercesTreeOperations::SetValue(xercesc::DOMNode* pNode, const conforme::MemberInfo* pMemberInfo, unsigned b)
{
    SetValue(pNode, pMemberInfo, GetFormatter(pMemberInfo)->Format((unsigned __int64)b));
}

void XercesTreeOperations::SetValue(xercesc::DOMNode* pNode, const conforme::MemberInfo* pMemberInfo, __int64 b)
{
    SetValue(pNode, pMemberInfo, GetFormatter(pMemberInfo)->Format(b));
}

void XercesTreeOperations::SetValue(xercesc::DOMNode* pNode, const conforme::MemberInfo* pMemberInfo, unsigned __int64 b)
{
    SetValue(pNode, pMemberInfo, GetFormatter(pMemberInfo)->Format(b));
}

void XercesTreeOperations::SetValue(xercesc::DOMNode* pNode, const conforme::MemberInfo* pMemberInfo, double b)
{
    SetValue(pNode, pMemberInfo, GetFormatter(pMemberInfo)->Format(b));
}

void XercesTreeOperations::SetValue(xercesc::DOMNode* pNode, const conforme::MemberInfo* pMemberInfo, conforme::DateTime b)
{
    SetValue(pNode, pMemberInfo, GetFormatter(pMemberInfo)->Format(b));
}

void XercesTreeOperations::SetValue(xercesc::DOMNode* pNode, const conforme::MemberInfo* pMemberInfo, conforme::Duration b)
{
    SetValue(pNode, pMemberInfo, GetFormatter(pMemberInfo)->Format(b));
}

void XercesTreeOperations::SetValue(xercesc::DOMNode* pNode, const conforme::MemberInfo* pMemberInfo, const std::vector<unsigned char>& b)
{
    SetValue(pNode, pMemberInfo, GetFormatter(pMemberInfo)->Format(b));
}


void XercesTreeOperations::SetValue(xercesc::DOMNode* pNode, const conforme::MemberInfo* pMemberInfo, const xercesc::DOMNode* b)
{
...
xercesc::DOMNode* XercesTreeOperations::AddElement(xercesc::DOMNode* pNode, const conforme::MemberInfo* pMemberInfo)
{
    string_type prefix;
    if (*pMemberInfo->NamespaceURI)
    {
...
double XercesTreeOperations::CastToDouble(const xercesc::DOMNode* pNode, const conforme::MemberInfo* pMemberInfo)
{
    return conforme::CoreTypes::CastToDouble(GetTextContent(pNode));
}


string_type XercesTreeOperations::CastToString(const xercesc::DOMNode* pNode, const conforme::MemberInfo* pMemberInfo)
{
    return conforme::CoreTypes::CastToString(GetTextContent(pNode));
}


__int64 XercesTreeOperations::CastToInt64(const xercesc::DOMNode* pNode, const conforme::MemberInfo* pMemberInfo)
{
    return conforme::CoreTypes::CastToInt64(GetTextContent(pNode));
}

unsigned __int64 XercesTreeOperations::CastToUInt64(const xercesc::DOMNode* pNode, const conforme::MemberInfo* pMemberInfo)
{
    return conforme::CoreTypes::CastToUInt64(GetTextContent(pNode));
}

unsigned XercesTreeOperations::CastToUInt(const xercesc::DOMNode* pNode, const conforme::MemberInfo* pMemberInfo)
{
    return conforme::CoreTypes::CastToUInt(GetTextContent(pNode));
}

int XercesTreeOperations::CastToInt(const xercesc::DOMNode* pNode, const conforme::MemberInfo* pMemberInfo)
{
    return conforme::CoreTypes::CastToInt(GetTextContent(pNode));
}


bool XercesTreeOperations::CastToBool(const xercesc::DOMNode* pNode, const conforme::MemberInfo* pMemberInfo)
{
    return conforme::CoreTypes::CastToBool(GetTextContent(pNode));
}

conforme::DateTime XercesTreeOperations::CastToDateTime(const xercesc::DOMNode* pNode, const conforme::MemberInfo* pMemberInfo)
{
    return conforme::CoreTypes::CastToDateTime(GetTextContent(pNode));
}

conforme::Duration XercesTreeOperations::CastToDuration(const xercesc::DOMNode* pNode, const conforme::MemberInfo* pMemberInfo)
{
    return conforme::CoreTypes::CastToDuration(GetTextContent(pNode));
}

std::vector<unsigned char> XercesTreeOperations::CastToBinary(const xercesc::DOMNode* pNode, const conforme::MemberInfo* pMemberInfo)
{
    return GetFormatter(pMemberInfo)->ParseBinary(GetTextContent(pNode));
}

conforme::QName XercesTreeOperations::CastToQName(const xercesc::DOMNode* pNode, const conforme::MemberInfo* pMemberInfo)
{
    ...
    if (i == string_type::npos)
    {
        ...
        return conforme::QName(defaultNsUri, value);
    }
    ...
    return conforme::QName(uri, prefix, local);
}

xercesc::DOMNode* XercesTreeOperations::FindAttribute(
                                                      xercesc::DOMNode* pNode, const conforme::MemberInfo* member)
{
...
void XercesTreeOperations::RemoveAttribute(xercesc::DOMNode* pNode, const conforme::MemberInfo* member)
{
    if (*member->LocalName)
    {
...
void XercesTreeOperations::RemoveElements(xercesc::DOMNode* pNode, const conforme::MemberInfo* member)
{
    for (xercesc::DOMNode* pChild = pNode->getFirstChild(); pChild; )
    {
        xercesc::DOMNode* cur = pChild;
...
void XercesTreeOperations::RemoveElement(xercesc::DOMNode* pNode, const conforme::MemberInfo* member, unsigned index)
{
    for (xercesc::DOMNode* pChild = pNode->getFirstChild(); pChild; )
    {
        xercesc::DOMNode* cur = pChild;
                                                                      ...
                                                                      const string_type& filename)
{
    ...
    {
        throw conforme::DataSourceUnavailableException(filename + _T(": Xerces XML error while loading: ") + string_type(XercesUnstringTemp(error.getMessage())));
    }
    catch (xercesc::SAXException& error)
    {
        throw conforme::DataSourceUnavailableException(filename + _T(": Xerces SAX error while loading: ") + string_type(XercesUnstringTemp(error.getMessage())));
    }
    catch (xercesc::DOMException&)
    {
        throw conforme::DataSourceUnavailableException(filename + _T(": Xerces DOM error while loading"));
    }
}
...
void XercesTreeOperations::SaveDocument( const DocumentType& document, const string_type& filename, bool prettyPrint, const string_type& lineend )
{
    SaveDocument( document, filename, prettyPrint, false, _T("UTF-8"), false, false, lineend );
}

void XercesTreeOperations::SaveDocument( const DocumentType& document, const string_type& filename, bool prettyPrint, bool omitXmlDecl, const string_type& lineend )
{
    SaveDocument( document, filename, prettyPrint, omitXmlDecl, _T("UTF-8"), false, false, lineend );
}

void XercesTreeOperations::SaveDocument( const DocumentType& document, const string_type& filename, bool prettyPrint, const string_type& encoding, bool bBigEndian, bool bBOM, const string_type& lineend )
{
    SaveDocument( document, filename, prettyPrint, false, encoding, bBigEndian,  bBOM, lineend );
}

void XercesTreeOperations::SaveDocument( const DocumentType& document, const string_type& filename, bool prettyPrint, bool omitXmlDecl, const string_type& encoding, bool bBigEndian, bool bBOM, const string_type& lineend )
{
    std::vector<unsigned char> bytes;
    SaveToBinary( bytes, document, prettyPrint, encoding, bBigEndian, bBOM, lineend, !omitXmlDecl );
    
    FILE *f = _tfopen( filename.c_str(), _T("wb") );
    if( !f )
        throw conforme::DataTargetUnavailableException( _T("Could not open file ") + filename + _T(" for writing.") );
...
XercesTreeOperations::DocumentType XercesTreeOperations::LoadXml(const string_type& xml)
{
    ...
    {
        throw conforme::DataSourceUnavailableException(_T("Xerces XML error while loading: ") + string_type(XercesUnstringTemp(error.getMessage())));
    }
    catch (xercesc::SAXException& error)
    {
        throw conforme::DataSourceUnavailableException(_T("Xerces SAX error while loading: ") + string_type(XercesUnstringTemp(error.getMessage())));
    }
    catch (xercesc::DOMException&)
    {
        throw conforme::DataSourceUnavailableException(_T("Xerces DOM error while loading"));
    }
}
...
string_type XercesTreeOperations::SaveXml(const DocumentType& document, bool prettyPrint, const string_type& lineend)
{
    return SaveXml( document, prettyPrint, false, lineend );
}

string_type XercesTreeOperations::SaveXml(const DocumentType& document, bool prettyPrint, bool omitXmlDecl, const string_type& lineend)
{
    try
    {
        ...
        if (omitXmlDecl && pLSSerializer->getDomConfig()->canSetParameter(xercesc::XMLUni::fgDOMXMLDeclaration, false))
        {
            pLSSerializer->getDomConfig()->setParameter(xercesc::XMLUni::fgDOMXMLDeclaration, false);
        }
    ...
    {
        throw conforme::DataTargetUnavailableException(_T("Xerces XML error while saving: ") + string_type(XercesUnstringTemp(error.getMessage())));
    }
    catch (xercesc::SAXException& error)
    {
        throw conforme::DataTargetUnavailableException(_T("Xerces SAX error while saving: ") + string_type(XercesUnstringTemp(error.getMessage())));
    }
    catch (xercesc::DOMException&)
    {
        throw conforme::DataTargetUnavailableException(_T("Xerces DOM error while saving"));
    }
}
...
std::vector<unsigned char> XercesTreeOperations::SaveToBinary(const DocumentType& document, bool prettyPrint, const string_type& lineend)
{
    return SaveToBinary(document, prettyPrint, false, lineend);
}

std::vector<unsigned char> XercesTreeOperations::SaveToBinary(const DocumentType& document, bool prettyPrint, bool omitXmlDecl, const string_type& lineend)
{
    std::vector<unsigned char> result;
    SaveToBinary( result, document, prettyPrint, _T(""), false, false, lineend, !omitXmlDecl );
    return result;
}

void XercesTreeOperations::SaveToBinary( std::vector<unsigned char>& result, const DocumentType& document, bool prettyPrint, const string_type& encoding, bool bBigEndian, bool bBOM, const string_type& lineend, bool bIncludeEncoding )
{
    try
    {
        ...
        HoldDOMLSSerializer pLSSerializer( xercesc::DOMImplementation::getImplementation()->createLSSerializer() );
        pLSSerializer->setNewLine( XercesStringTemp( lineend.c_str() ) );
        ...
        if (!bIncludeEncoding && pLSSerializer->getDomConfig()->canSetParameter(xercesc::XMLUni::fgDOMXMLDeclaration, false))
        {
            pLSSerializer->getDomConfig()->setParameter(xercesc::XMLUni::fgDOMXMLDeclaration, false);
        }
        ...
        if( !bRet )
            throw conforme::DataTargetUnavailableException( _T("Xerces XML error while saving.") );
    }
    catch (xercesc::XMLException& error)
    {
        throw conforme::DataTargetUnavailableException(_T("Xerces XML error while saving: ") + string_type(XercesUnstringTemp(error.getMessage())));
